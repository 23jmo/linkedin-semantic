...
export default function EmailGenerator() {
  ...
  return (
    ...
    >
      ...
      <div className="space-y-4 mb-4" data-oid="uf33jq9">
        <div data-oid=".t_k.2w">
          <label
        ...
        {error && (
          <div className="text-red-500 text-sm" data-oid="xc69oa.">
            {error}
          </div>
        )}
